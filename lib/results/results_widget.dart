                      ...
                      children: [
                        ...
                        Expanded(
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 0.0, 0.0, 16.0),
                            child: StreamBuilder<List<GSRSessionsRecord>>(
                              stream: queryGSRSessionsRecord(
                                parent: currentUserReference,
                                queryBuilder: (gSRSessionsRecord) =>
                                    gSRSessionsRecord.orderBy('date_uploaded'),
                              ),
                              builder: (context, snapshot) {
                                ...
                                List<GSRSessionsRecord>
                                    listViewGSRSessionsRecordList =
                                    snapshot.data!;
                                if (listViewGSRSessionsRecordList.isEmpty) {
                                  return Center(
                                ...
                                return ListView.builder(
                                  ...
                                  itemCount:
                                      listViewGSRSessionsRecordList.length,
                                  itemBuilder: (context, listViewIndex) {
                                    final listViewGSRSessionsRecord =
                                        listViewGSRSessionsRecordList[
                                            listViewIndex];
                                    return Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 0.0,
                                                                0.0, 10.0),
                                                    child: Text(
                                                      'Session ${(listViewIndex + 1).toString()}',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .titleMedium
