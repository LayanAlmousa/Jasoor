...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0088FF);
  late Color secondary = const Color(0xFFC5E4FF);
  late Color tertiary = const Color(0xFFFF7700);
  ...
  late Color accent1 = const Color(0xFF71BAFA);
  late Color accent2 = const Color(0x4C8AC7FF);
  late Color accent3 = const Color(0x4CEE8B60);
  late Color accent4 = const Color(0xFFFFA45E);
  late Color success = const Color(0xFF4CD95D);
  late Color warning = const Color(0xFFFFCC00);
  late Color error = const Color(0xFFFF3130);
